...
const Login = () => {
    return (
        <div className='mt-[200px] md:px-[100px] px-[30px] mb-[100px] flex justify-center '>
            <div className='bg-[#FEF0E7] w-[400px] pt-[48px] px-[40px] relative rounded-[15px]'>
                ...
                <div className='w-full flex flex-col items-center'>
                    ...
                    <p className='text-center my-[24px] text-[14px] text-[#828181]'>Sign in to your account using email and password provided during registration.</p>
                </div>
                <div>
                    ...
                    <div>
                        <div className='flex justify-between items-center'>
                            <div className='flex items-center'>
                                ...
                                <label htmlFor="checkbox" className='text-[14px] ms-[10px]'>Keep me signed in</label>
                            </div>
                            <div>
                                <Link to='/' className='text-[14px] text-[#F6623E]'>Forget password?</Link>
                            </div>
                        </div>
                        <div className='flex my-[24px]'>
                            <button className='w-full bg-[#F6623E] py-[10px] rounded-[8px] text-[#fff] uppercase font-medium'>Sign In</button>
                        </div>
                        <div className='pb-[8px] border-b-[1px] border-[#828181]'>
                            <span className='text-[14px]'>Don't have an account? <Link to='/register' className='font-medium text-[#F6623E]'>Sign up</Link></span>
                        </div>
                    </div>
                </div>
